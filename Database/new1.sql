...
alter table ATTENDANCE
   add constraint PK_ATTENDANCE primary key (ATT_ID, DATE)
go
...
alter table BELONG_TO
   add constraint PK_BELONG_TO primary key (DEP_ID, FACULTYID)
go
...
alter table BELONG_TO
   add constraint FK_BELONG_T_BELONG_TO_FACULTY foreign key (FACULTYID)
...
(null,'Biology',8), (null,'MIS',10), (null,'Law1',12);
insert into Doctor values (1, 1, 'D0001', 'fff','ttt', 29, 'abc@live.com', 'Beirut');
...
insert into Doctor values (null, 2, 'F0001', 'Bassam','Badran', 45, 'aaa@live.com', 'Beirut'),
						  (null, 2, 'S0001', 'Test1','Test1', 46, 'bbb@live.com', 'Beirut'),
						  (null, 2, 'S0002', 'Test2','Test2', 46, 'ccc@live.com', 'Zahle');
						  
insert into FACULTY values (2, 'Science'), (3, 'Business'), (1, 'Law');

insert into SECTION values (2, 1,'01xxxxxx','Hadath'), (4, 3,'01xxxxxx', 'Zahle');

insert into HAS values (1,1), (2,1) , (3,1), (1,2), (3,2);

insert into BELONG_TO values (1,1), (2,1) , (3,1), (4,1), (5,2), (6,3);

insert into Role values ('Secretary'), ('Doctor');